...
module.exports = {
  ...
  development: {
    ...
    connection: {
      ...
      database: process.env.DB_DEVELOPMENT_NAME || 'auth',
      user:  process.env.DB_DEVELOPMENT_USER || 'root',
      password: process.env.DB_DEVELOPMENT_PASSWORD || 'dgplatac'
    },
    pool: {
      min: 2,
      max: 10
  ...
  production: {
    ...
    connection: {
      ...
      database: process.env.DB_PRODUCTION_NAME || 'auth',
      user:  process.env.DB_PRODUCTION_USER || 'root',
      password: process.env.DB_PRODUCTION_PASSWORD || 'dgplatac'
    },
    pool: {
      min: 2,
      max: 10
